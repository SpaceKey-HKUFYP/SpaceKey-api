...
//	  if(built == false)   System.out.println("query->built->null");
//	  
//	    if (!built) { 
//	    	build();
...
//	    if (itemBoundables.isEmpty()) {
//	      Assert.isTrue(root.getBounds() == null);
//	      System.out.println("Assert: if");
//	    }else{
//	    	System.out.println("Assert: else");
//	    }
//	    
//	    if(root == null)   System.out.println("query->root2->null");
//	     
//	    if (getIntersectsOp().intersects(root.getBounds(), searchBounds)) {
//          query(searchBounds, root, matches);
//        }
  ...
  //2016-8-7 added by Yixiang Fang
  public AbstractNode findRoot(){
	  if (!built) { build(); }
	  return root;
  }
